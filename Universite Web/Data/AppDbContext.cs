...
namespace Universite_Web.Data
{
    public class AppDbContext:IdentityDbContext
    {
        ...
        public DbSet<RegisterSTUDENT> RegisterSTUDENT { get; set; }
        public DbSet<RegisterTEACHER> RegisterTEACHER { get; set; }
        public DbSet<Seminar> Seminar { get; set; }
        public DbSet<SerbestIs> SerbestIs { get; set; }
        public DbSet<Specialty> Specialty { get; set; }
        public DbSet<StudentPanel> StudentPanel { get; set; }
        public DbSet<Subject> Subject { get; set; }
        public DbSet<TeacherPanel> TeacherPanel { get; set; }
